...
st.header("Insights")
st.markdown("The analysis of these particular data sets have allowed me to come to the following conclusions. In 2015 at the Boston Marathon, the fastest runners were most likly men in their mid 20's. But, if you want to run a fast second half, (and probably a fast race) you shouldn't follow an 18 year old male, as he's likely to slow down towards the end. Rather one should find an experienced female runner in her upper 30's who has a similar time goal to you, she is more likely to make it to the end without slowing down too much, as per the overall average finishing times at Boston. There is also an indicated correlation with expirence in running and pace times. More expirenced runner tend to have a more even split than those who are less expirenced in running. Weather proved to have an affect on overall pace times, as the above graphs indicated that the warmer the tempurature got, the slower the median runner will finish their marathon. Indicating that if you come from a low tempurature training environment, and plan to race on a warm day, you should adjust your time goals accordingly.")
